...
* [big red yellow-background]*Demo (v1) : link:v1/[👉🏼500-to-English👈🏼🔥^]*
* [big red yellow-background]*Demo (v2) : link:v1/[👉🏼600-to-English👈🏼🔥^]*
* link:data-v1.html[Dataset (v1)^] | link:data-v2.html[Dataset (v2)^]
...
IMAGE=600toEng-v2.0  # v2, 600-Eng
IMAGE=600toEng-v2.0-arm64 # v2 for arm64/aarch64 such as Apple Silicon (M1*)
