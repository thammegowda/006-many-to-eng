...
NOTE: The demo hosted at http://rtg.isi.edu is down (TG has left USC/ISI and the compute allocated to his account is removed). Please use docker images for RTG pretrained models and OPUS mirror for prepared dataset.
